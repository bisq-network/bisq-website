$( document ).ready( function() {
    ...
    var fiatVolumeChart = Highcharts.chart( 'fiat-volume-container', {
        ...
        series: [{
            ...
            data: [11.8995,41.3696,32.0541,40.8324,116.6891,73.2759,81.5417,115.763,168.2711,179.9098,114.6693,140.0966,142.6057,178.7778,116.686,58.4357,79.3912,61.1235,56.7454,54.829,64.6699,54.245,48.825,43.7748,41.1994,49.3965,66.1055,41.8279,40.148,40.8045,50.4425,59.1317,70.7977,77.302,84.2301,89.5436,86.4997,53.4374,44.2075,41.7215,50.2143,45.8008,54.1624]
        }],
        legend: {
            enabled: false
        }
    ...
    var altcoinVolumeChart = Highcharts.chart( 'altcoin-volume-container', {
      ...
      var bsqChart = Highcharts.chart( 'bsq-container', {
        ...
        xAxis: {
            categories: ["Oct '17","Nov '17","Dec '17","Jan '18","Feb '18","Mar '18","Apr '18","May '18","Jun '18","Jul '18","Aug '18","Sep '18","Oct '18","Nov '18","Dec '18","Jan '19","Feb '19","Mar '19","Apr '19","May '19","Jun '19","Jul '19","Aug '19","Sep '19","Oct '19"],
            labels: {
                step: 2,
                style: {
                    color: "#bababa"
        ...
        series: [{
            ...
            data: [2548500,2620250,2671850,2722950,2769150,2806330,2830832,2868164,2889799,2934231,2971823,3018665,3052400,3272927,3344765,3406635,3520705,3657480,3726799,3726799,3735459,3727371,3704333,3774343,3848333.41]
        }],
        legend: {
            enabled: false
        }
