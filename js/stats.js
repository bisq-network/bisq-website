$( document ).ready( function() {
    ...
    var volumeChart = Highcharts.chart( 'volume-container', {
          ...
          xAxis: {
              categories: ["Apr '16","May '16","Jun '16","Jul '16","Aug '16","Sep '16","Oct '16","Nov '16","Dec '16","Jan '17","Feb '17","Mar '17","Apr '17","May '17","Jun '17","Jul '17","Aug '17","Sep '17","Oct '17","Nov '17","Dec '17","Jan '18","Feb '18","Mar '18","Apr '18","May '18","Jun '18","Jul '18","Aug '18","Sep '18","Oct '18","Nov '18","Dec '18","Jan '19","Feb '19", "Mar '19", "Apr '19", "May '19"],
              labels: {
                  step: 3,
                  style: {
                      color: "#bababa"
      ...
      var bsqChart = Highcharts.chart( 'bsq-container', {
        ...
        xAxis: {
            categories: ["Oct '17","Nov '17","Dec '17","Jan '18","Feb '18","Mar '18","Apr '18","May '18","Jun '18","Jul '18","Aug '18","Sep '18","Oct '18","Nov '18","Dec '18","Jan '19","Feb '19", "Mar '19", "Apr '19", "May '19"],
            labels: {
                step: 2,
                style: {
                    color: "#bababa"
        ...
        series: [{
            ...
            data: [2548500,2620250,2671850,2722950,2769150,2806330,2830832,2868164,2889799,2934231,2971823,3018665,3052400,3272927,3344765,3406635,3520705,3657480,3726799,3726799]
        }],
        legend: {
            enabled: false
        }
