...
Our [roadmap]({{ site.baseurl }}/roadmap/) provides an overview of high-level features and milestones on the way to Bisq v1.0.

## Stay up-to-date

[Sign up for the Bisq newsletter](http://bitsquare.us9.list-manage.com/subscribe?u=fee3c64b1504e7835a98b0ed3&id=dc09b9ca64) so you never miss an important update! Unlike the [Bisq mailing list]({{ site.baseurl }}/community/#mailing-list), which can see higher message volumes, the newsletter is reserved for important announcements, such as when we release new milestones. Of course, you can unsubscribe at any time.
