...
### [Exchanges](https://en.wikipedia.org/wiki/Bitcoin_exchange#List_of_Bitcoin_Exchanges){:target="_blank"} desempenham um papel fundamental no ecossistema do Bitcoin. Sem elas, seria quase impossível comprar ou vender bitcoins com euros, dólares, reais ou yuans. O mercado de bitcoin não teria liquidez e bitcoin não teria valor.
...
<ul>
  <li>Querem trocar uma moeda nacional, como reais, dólares ou euros por bitcoin.</li>
  <li>Querem trocar uma ampla gama de criptomoedas alternativas por bitcoin.</li>
  <li>Não querem depender qualquer exchange para a custódia de seus fundos.</li>
  <li>Não querem perder o controle ou a privacidade para uma autoridade central, a fim de negociar com outros indivíduos.</li>
  <li>Consideraram transações financeiras uma forma de expressão privada que deve ser protegida da vigilância constante por parte dos bancos, governos e outras instituições.</li>
</ul>
